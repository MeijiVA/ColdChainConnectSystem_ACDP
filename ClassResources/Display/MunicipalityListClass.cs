...
{
    internal class MunicipalityListClass
    {
        public static string[] municipality =
{
    ...
    "Talacogon, Agusan del Sur", // Corrected entry spanning source 28 and 29
    ...
    "Abucay, Bataan",
    "Bagac, Bataan", // Corrected entry spanning source 29 and 30
    "Dinalupihan, Bataan",
    "Hermosa, Bataan",
    "Limay, Bataan",
    "Mariveles, Bataan",
    ...
    "Getafe, Bohol", // Corrected entry spanning source 30 and 31
    "Guindulman, Bohol",
    "Inabanga, Bohol",
    "Jagna, Bohol",
    "Lila, Bohol",
    ...
    "Peñablanca, Cagayan",
    "Piat, Cagayan",
    "Rizal, Cagayan", // Corrected entry spanning source 31 and 32
    ...
    "San Fernando, Camarines Sur", // Corrected entry spanning source 32 and 33
    ...
    "Pinamungajan, Cebu",
    "Poro, Cebu",
    "Ronda, Cebu", // Corrected entry spanning source 33 and 34
    "Samboan, Cebu",
    "San Fernando, Cebu",
    "San Francisco, Cebu",
    "San Remigio, Cebu",
    ...
    "Bansalan, Davao del Sur", // Corrected entry spanning source 34 and 35
    ...
    "Llorente, Eastern Samar", // Corrected entry spanning source 35 and 36
    ...
    "Cabugao, Ilocos Sur",
    "Caoayan, Ilocos Sur",
    "Cervantes, Ilocos Sur", // Corrected entry spanning source 36 and 37
    ...
    "Pototan, Iloilo",
    "San Dionisio, Iloilo",
    "San Enrique, Iloilo", // Corrected entry spanning source 37 and 38
    "San Joaquin, Iloilo",
    "San Miguel, Iloilo",
    "San Rafael, Iloilo",
    ...
    "San Juan, La Union",
    "Santo Tomas, La Union", // Corrected entry spanning source 38 and 39
    "Santol, La Union",
    "Sudipen, La Union",
    "Tubao, La Union",
    "Alaminos, Laguna",
    ...
    "Tangcal, Lanao del Norte", // Corrected entry spanning source 39 and 40
    ...
    "Saguiaran, Lanao del Sur", // Corrected entry spanning source 40 and 41
    ...
    "Datu Unsay, Maguindanao", // Corrected entry spanning source 41 and 42
    ...
    "Tudela, Misamis Occidental", // Corrected entry spanning source 42 and 43
    ...
    "Pateros,Pateros", // Special case - a single municipality/metropolitan area [cite: 43]
    ...
    "Pulupandan, Negros Occidental", // Corrected entry spanning source 43 and 44
    ...
    "San Roque, Northern Samar", // Corrected entry spanning source 44 and 45
    ...
    "Santa Fe, Nueva Vizcaya", // Corrected entry spanning source 45 and 46
    ...
    "Magalang, Pampanga",
    "Masantol, Pampanga",
    "Mexico, Pampanga", // Corrected entry spanning source 46 and 47
    "Minalin, Pampanga",
    "Porac, Pampanga",
    "San Luis, Pampanga",
    "San Simon, Pampanga",
    ...
    "Real, Quezon",
    "Sampaloc, Quezon",
    "San Andres, Quezon", // Corrected entry spanning source 47 and 48
    "San Antonio, Quezon",
    ...
    "Lazi, Siquijor",
    "Maria, Siquijor",
    "San Juan, Siquijor", // Corrected entry spanning source 48 and 49
    "Siquijor, Siquijor",
    "Barcelona, Sorsogon",
    "Bulan, Sorsogon",
    "Bulusan, Sorsogon",
    ...
    "President Quirino, Sultan Kudarat", // Corrected entry spanning source 49 and 50
    ...
    "Bayabas, Surigao del Sur", // Corrected entry spanning source 50 and 51
    ...
    "San Narciso, Zambales", // Corrected entry spanning source 51 and 52
    "Santa Cruz, Zambales",
    "Subic, Zambales",
    ...
    "Dumalinao, Zamboanga del Sur", // Corrected entry spanning source 52 and 53
    ...
    "Titay, Zamboanga Sibugay", // Corrected entry spanning source 53 and 54
