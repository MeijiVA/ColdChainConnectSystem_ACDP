...
namespace ColdChainConnectSystem_ACDP.AppForms.MainPanel.Inventory
{
    public partial class InventoryForm : Form
    {
        ...
        private void InventoryForm_Load(object sender, EventArgs e)
        {
            ...
            dgvTable.Columns.Add(InventoryColumn.columnSkuCode());
            dgvTable.Columns.Add(InventoryColumn.columnDescription());
            dgvTable.Columns.Add(InventoryColumn.columnImage());
            dgvTable.Columns.Add(InventoryColumn.columnUnitPrice());
            dgvTable.Columns.Add(InventoryColumn.columnAmount());
            dgvTable.Columns.Add(InventoryColumn.columnKG());
            dgvTable.Columns.Add(InventoryColumn.columnQuantity());
            //
            dgvTable.Columns.Add(DataGridViewButtons.AddViewCol_dgvButton());
            dgvTable.Columns.Add(DataGridViewButtons.AddEditCol_dgvButton());
            dgvTable.Columns.Add(DataGridViewButtons.AddDelCol_dgvButton());
